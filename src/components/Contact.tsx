    ...
    >
      <div className="max-w-content text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {links.map((link, i) => (
            <a
              ...
              className="flex items-center gap-3 px-6 py-3 rounded-full border border-border hover:border-accent text-muted hover:text-accent transition-colors"
            >
              {link.icon}
        ...
        <p className="mt-16 text-xs text-muted">
          &copy; {new Date().getFullYear()} Josue Garcia. Built with Next.js &amp; TailwindCSS.
        </p>
      </div>
    </section>
  );
